...
void FOTAHandler::final_OTA()
{
  Serial.println("Fin OTA. Reiniciando...");
}

void FOTAHandler::inicio_OTA()
{
  Serial.println("Nuevo Firmware encontrado. Actualizando...");
}

void FOTAHandler::error_OTA(int e)
{
  char cadena[64];
...
void FOTAHandler::progreso_OTA(int x, int todo)
{
  char cadena[256];
